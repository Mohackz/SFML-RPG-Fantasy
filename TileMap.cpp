...
zt::TileMap::TileMap() : sf::Drawable()
{
    _fileMapPath = "";
    _tilesetPath = "";
...
zt::TileMap::TileMap(const std::string& mapPath)
{
    loadMap(mapPath);
}
...
bool zt::TileMap::loadMap(const std::string& mapPath)
{
...
sf::Vector2u zt::TileMap::getSize()
{
...
zt::Editor::Editor(const std::string& mapPath) : zt::TileMap(mapPath)
{
    _posMouse = sf::Vector2i(0,0);
    _currentObject = sf::Vector2u(0,0);
    m_extension = "lvl";
...
void zt::Editor::save()
{
    ...
    ofstream mapTosave("editMap."+m_extension,ios::out|ios::trunc);
...
void zt::Editor::setExtension(const std::string& ext)
{
    m_extension = ext;
}
